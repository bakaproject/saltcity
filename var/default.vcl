...
if (req.url ~ "^(/store/media/|/store/skin/|/store/js/|/store/)(?:(?:index|litespeed)\.php/)?") {
set req.http.X-Turpentine-Secret-Handshake = "1";
if (req.url ~ "^(/store/media/|/store/skin/|/store/js/|/store/)(?:(?:index|litespeed)\.php/)?backend") {
...
if (req.url ~ "^(/store/media/|/store/skin/|/store/js/|/store/)(?:(?:index|litespeed)\.php/)?(?:backend|api|cron\.php)" ||
